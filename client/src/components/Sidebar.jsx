...
import { SettingsOutlined, ChevronLeft, ChevronRightOutlined, HomeOutlined} from '@mui/icons-material'
    ...
    <Box component="nav">
      {isSidebarOpen && (
        ...
        >
          ...
          <Box sx={{ flexShrink: 0, p: "1.5rem 2rem", display: "flex", justifyContent: "center" }}>
            <Divider />
